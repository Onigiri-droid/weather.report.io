...
import {getPressureMm, getTime} from '../assets/utils'
...
const timezone = computed(() => props.wetherInfo?.timezone)

const sunriseTime = computed(() => {
  return getTime(props.wetherInfo?.sys?.sunrise + timezone.value)
})

const sunsetTime = computed(() => {
  return getTime(props.wetherInfo?.sys?.sunset + timezone.value)
})
</script>

<template>
  <div class="section highlights">
    <div class="title">Основные события сегодняшнего дня</div>
    <div class="highlights-wrapper">
      <div class="highlight">
        <div class="card">
          ...
          <div class="card-info">
            <div class="card-justify">
              <div class="info-main">
                <div class="info-main-num">{{wetherInfo?.wind?.speed}}</div>
                <div class="info-main-text">м/с</div>
              </div>
              <div class="info-main">
                <div class="info-main-num">{{wetherInfo?.wind?.deg}}</div>
                <div class="info-main-text">град.</div>
              </div>
            </div>
          </div>
        </div>
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div v-if="wetherInfo?.wind?.gust" class="card-small-data">
              <div class="info-main-num">{{Math.round(wetherInfo?.wind?.gust)}}</div>
              <div class="info-main-text">м/с</div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-info">
            <div class="card-centered">
              <div class="info-main">
                <div class="info-main-num">{{getPressureMm(wetherInfo?.main?.pressure)}}</div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data">
              <div class="info-main-num">{{Math.round(wetherInfo?.main?.feels_like)}}</div>
              <div class="info-main-text">°C</div>
            </div>
            <div class="card-small-hint">
              <div class="card-small-pic card-small-pic--margin card-small-pic--pressure"></div>
              <div class="card-small-text">Насколько жарко или холодно ощущается</div>
            </div>
          </div>
        </div>
      </div>
      <div class="highlight">
        <div class="card">
          <div class="card-title">Восход и заход солнца</div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data">
              <div class="info-main-num">{{wetherInfo?.clouds?.all}}</div>
